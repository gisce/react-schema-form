...
var SchemaForm = function (_React$Component) {
    ...
    _createClass(SchemaForm, [{
        ...
        value: function builder(form, model, index, onChange, mapper) {
            ...
            return _react2.default.createElement(Field, { onRef: function onRef(ref) {
                    return _this2.childs = ref;
                }, model: model, form: form, key: key, onChange: onChange, mapper: mapper, builder: this.builder });
        }
    }, {
        key: 'render',
