...
var TextSuggest = function (_React$Component) {
    ...
    _createClass(TextSuggest, [{
        ...
        value: function __handleInit__REACT_HOT_LOADER__(init_value) {
            ...
            this.handleUpdate((_handleUpdate = {}, _defineProperty(_handleUpdate, dataSourceConfig['value'], init_value), _defineProperty(_handleUpdate, dataSourceConfig['text'], init_value_name), _handleUpdate));
